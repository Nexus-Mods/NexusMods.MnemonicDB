...
public partial class MyModelArrayTest : __MODELS__.IModelFactory<MyModelArrayTest, MyModelArrayTest.ReadOnly>
{
    ...
    /// </summary>
    public static IEnumerable<MyModelArrayTest.ReadOnly> All(__ABSTRACTIONS__.IDb db) {
    ...
    public required int[] MyAttribute 
    {
        set => _datoms.Add(Id, NexusMods.MnemonicDB.SourceGenerator.Tests.MyModelArrayTest.MyAttribute, value);
    }
        #endregion
    }
    ...
    public readonly partial struct ReadOnly :
        __MODELS__.IReadOnlyModel<MyModelArrayTest.ReadOnly> {
           ...
           /// <inheritdoc cref="MyModelArrayTest.MyAttribute" />
           public int[] MyAttribute => NexusMods.MnemonicDB.SourceGenerator.Tests.MyModelArrayTest.MyAttribute.GetFrom(this);
