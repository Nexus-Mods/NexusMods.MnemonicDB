...
{
    public override (ushort, string) ToLowLevel((LocationId, RelativePath) value) 
        => (value.Item1.Value, value.Item2.Path);

    public override (LocationId, RelativePath) FromLowLevel((ushort, string) value, AttributeResolver resolver)
    {
