...
public static class BuiltInAttributes
{
    ...
    private static readonly Symbol UniqueIdStaticId =
        Symbol.InternPreSanitized("NexusMods.EventSourcing.DatomStore/UniqueId");
    ...
    private static readonly Symbol ValueSerializerIdStaticId =
        Symbol.InternPreSanitized("NexusMods.EventSourcing.DatomStore/ValueSerializerId");
    ...
    public class ValueSerializerId()
        : ScalarAttribute<ValueSerializerId, Symbol>("NexusMods.EventSourcing.DatomStore/ValueSerializerId");
}
